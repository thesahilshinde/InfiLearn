...
?>
            ...
            <body>
                ...
                $sql = "SELECT * FROM fileuploaded WHERE id = '$file_upload_id' ";
                ...
                ?>
                    ...
                    <div style="width:100vh;position:absolute;top:12vh;left:35vh;">
                        ...
                        <form id="videoUploadAdmin" action="editFileUpload.php?key=<?php echo $file_upload_id; ?>" method="post" enctype="multipart/form-data">
